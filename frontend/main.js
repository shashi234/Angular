...
let reflections = JSON.parse(localStorage.getItem('userreflections')) || [];
class FakeBackendInterceptor {
    intercept(request, next) {
        ...
        function handleRoute() {
            switch (true) {
                ...
                case url.endsWith('/users/register') && method === 'POST':
                    return register();
                case url.endsWith('/users/reflection') && method === 'POST':
                    return ureflecion();
                case url.endsWith('/users/reflection') && method === 'GET':
                    return getreflecions();
        ...
        function ureflecion() {
            ...
            u_ref.id = reflections.length ? Math.max(...reflections.map(x => x.id)) + 1 : 1;
            u_ref.uid = user;
            reflections.push(u_ref);
            localStorage.setItem('userreflections', JSON.stringify(reflections));
            return ok();
        }
        function getreflecions() {
...
/*!**********************************!*\
  !*** ./src/app/_models/index.ts ***!
  \**********************************/
/*! exports provided: Alert, AlertType, User, Reflection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _reflection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reflection */ "./src/app/_models/reflection.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Reflection", function() { return _reflection__WEBPACK_IMPORTED_MODULE_2__["Reflection"]; });
...
/***/ "./src/app/_models/reflection.ts":
/*!***************************************!*\
  !*** ./src/app/_models/reflection.ts ***!
  \***************************************/
/*! exports provided: Reflection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class AccountService {
    ...
    logReflection(rref) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/reflection`, rref);
    }
    getById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/${id}`);
    }
    getReflections() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/reflection`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(r => r.filter(x => x.uid == this.userValue.id)));
    }
    update(id, params) {
...
const reflectionsModule = () => __webpack_require__.e(/*! import() | reflection-reflection-module */ "reflection-reflection-module").then(__webpack_require__.bind(null, /*! ./reflection/reflection.module */ "./src/app/reflection/reflection.module.ts")).then(x => x.UsersModule);
const routes = [
    ...
    { path: 'users/reflection', loadChildren: reflectionsModule, canActivate: [_helpers__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
function AppComponent_nav_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Reflections");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "REFLECTION SYSTEM");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app"]], decls: 4, vars: 4, consts: [["class", "navbar navbar-expand navbar-dark bg-dark", 4, "ngIf"], [1, "app-container", 3, "ngClass"], [1, "navbar", "navbar-expand", "navbar-dark", "bg-dark"], [1, "navbar-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", "nav-link", 3, "routerLinkActiveOptions"], ["routerLink", "/users/reflection", "routerLinkActive", "active", 1, "nav-item", "nav-link"], [1, "nav-item", "nav-link", 3, "click"], [1, "main"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
class HomeComponent {
    constructor(formBuilder, account, router, alert) {
    ...
    ngOnInit() {
        this.form = this.formBuilder.group({
            rtime: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            rplace: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            step1: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required],
            step2: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]],
            step3: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]],
            step4: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]]
        });
    }
    onSubmit() {
        ...
        this.account.logReflection(this.form.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe({
            next: () => {
                this.alert.success('Reflection saved successfully', { keepAfterRouteChange: true });
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["ng-component"]], decls: 36, vars: 2, consts: [[1, "p-4"], [1, "container"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["type", "time", "formControlName", "rtime", 1, "form-control"], ["type", "text", "formControlName", "rplace", 1, "form-control"], [1, "help-block"], ["formControlName", "step1", "placeholder", "Focus on the five senses: what can you see, hear, taste, smell, touch? Log what you are observing in the matrix ", 1, "form-control"], ["formControlName", "step2", "placeholder", "Do you notice whether you feel relaxed and content, or tense and anxious? Are you aware of any sensations in your body? Describe. Log what you are observing in the matrix", 1, "form-control"], ["formControlName", "step3", "placeholder", "Intentions, images, attitudes, thoughts, feelings. Begin by just becoming aware of what enters your mind. Spend a few moments getting to know what arises in your mind. Notice how it comes about, and when it subsides. Are you of aware of yourself observing your mental activity? Log what you are observing in the matrix ", 1, "form-control"], ["formControlName", "step4", "placeholder", "Spend a few moments to sense their intention, mood, expectations, desires, etc. Be patient, focus on developing an intent to connect with others. Observe your own reactions, sensations, feelings, thoughts, desires. Any sense of connecting/disconnecting with others? How is this related to what you\u2019ve just been doing or thinking?  Log what you are observing in the matrix ", 1, "form-control"], ["type", "submit", "value", "Submit", 1, "btn", "btn-primary"], [1, "help-block", "sub_error"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](15, "Step1");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](20, "Step2");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "Step3");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](30, "Step4");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](31, "textarea", 10);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](32, "span", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"]], styles: [".form-group[_ngcontent-%COMP%]{\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: space-around;    \r\n}\r\nlabel[_ngcontent-%COMP%]{\r\n    margin-right: 1%;\r\n}\r\ninput[type=time][_ngcontent-%COMP%]{\r\n    margin-right: 1%;\r\n}\r\ntextarea.form-control[_ngcontent-%COMP%]{\r\n    resize: none;\r\n    height: 13vh;\r\n}\r\ninput[type=submit][_ngcontent-%COMP%]{\r\n    margin: auto;\r\n}\r\n.p-4[_ngcontent-%COMP%]{\r\n    margin-top: 2%\r\n}\r\nh1[_ngcontent-%COMP%]{\r\n    margin-top: 1%;\r\n    margin-left: 1%;\r\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{ templateUrl: 'home.component.html', styleUrls: ['home.style.css'] }]
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _app_services__WEBPACK_IMPORTED_MODULE_3__["AccountService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _app_services__WEBPACK_IMPORTED_MODULE_3__["AlertService"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! E:\edu\Masters\Reflection\Reflection\src\main.ts */"./src/main.ts");
